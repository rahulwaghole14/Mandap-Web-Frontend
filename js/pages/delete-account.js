...
document.addEventListener('DOMContentLoaded', () => {
    ...
    elements.mobileForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch(`${window.CONFIG.API_BASE_URL}/api/account/request-deletion`, {
                method: 'POST',
                headers: {
    ...
    elements.otpForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch(`${window.CONFIG.API_BASE_URL}/api/account/confirm-deletion`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    elements.cancelDeletionBtn.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch(`${window.CONFIG.API_BASE_URL}/api/account/cancel-deletion`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
